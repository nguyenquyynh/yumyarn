                            ...
                            >
                                <View centerH paddingT-120>
                                    <Animated.View style={{ zIndex: 1 }}>
                                        <Avatar source={{ uri: dataUser?.avatar || 'https://cdn.pixabay.com/photo/2020/01/07/16/41/vietnam-4748105_1280.jpg' }} size={100} imageStyle={styles.avatar} />
                                    </Animated.View>
                                    <View bg-puper style={styles.background}>
                                        <View row spread padding-x>
                                            <TouchableOpacity flex center onPress={() => navigation.navigate('FollowerList')} >
                                                <Text text70BO style={styles.numbercard}>{numberFormat(0)}</Text>
                                        ...
                                        <View paddingH-l centerH >
                                            <Text xviiiText style={styles.name}>{dataUser.name}</Text>
                                            <Text marginB-xv style={styles.name}>@{dataUser.tagName}</Text>
                                            {
                                                dataUser.story && (
                                                    <Text xivtext marginB-20 style={styles.story}>{dataUser.story}</Text>
                                                )
                                            }
                                        </View>
                                        {
